...
const Services = () => {
  ...
  return (
    <section className="max-w my-16 flex flex-col lg:flex-row gap-2">
      <div data-aos="fade-right" className="flex items-center gap-2 bg-secondary p-8 rounded-md">
      ...
      <div data-aos="flip-right" className="flex items-center gap-2 bg-secondary p-8 rounded-md">
      ...
      <div data-aos="flip-left" className="flex items-center gap-2 bg-secondary p-8 rounded-md">
      ...
      <div data-aos="fade-left" className="flex items-center gap-2 bg-secondary p-8 rounded-md">
