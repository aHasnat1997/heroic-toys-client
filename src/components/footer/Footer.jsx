...
const Footer = () => {
  return (
    <>
      ...
      <footer className="px-10 py-4 border-t bg-accent text-black border-base-300">
        <div className="max-w footer">
          <div className="items-center grid-flow-col">
            <img className="w-[10rem]" src={logo} alt="logo" />
            <p>Heroic Toys Ltd. <br />Providing Action Figure since 2020</p>
          </div>
